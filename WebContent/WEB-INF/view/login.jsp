  ...
  <div id="loginform" class="loginBox">
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="mt-20 skin-minimal" style="text-align: center;">
		<div class="radio-box">
			<input class="rd" type="radio" id="radio-2" name="type" checked value="2" />
			<label class="type" for="radio-1">学生</label>
		</div>
		<div class="radio-box">
			<input class="rd" type="radio" id="radio-3" name="type" value="3" />
			<label class="type" for="radio-2">老师</label>
		</div>
		<div class="radio-box">
			<input class="rd" type="radio" id="radio-1" name="type" value="1" />
			<label class="type" for="radio-3">管理员</label>
		</div>
	</div>
...
<div class="footer">201641404232&nbsp;&nbsp;&nbsp;&nbsp;梁闯荣&nbsp;&nbsp;&nbsp;&nbsp;16级软件卓越1班</div>
